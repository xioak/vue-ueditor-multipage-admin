    ...
    var Upload = {
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                // }
                //
                // $("<input type='hidden' id='umed_json_data'>")
                //
                ...
                //
                // var fms =  me.dialog.parent().find("iframe");
                // var jsondata = $(window.frames["up"].document).contents().find("pre").text();
          ...
          //             $("#upfilePath").val(data.msg);
          //         }else{
          //             layer.alert("上传失败，原因："+data.msg,{icon:2});
          //         }
          ...
          //     }
          //     layer.load();
          //     $('#upfileForm').ajaxSubmit(ajax_option);
          //     $('#btnupfile').attr('disabled',true);//将按钮不可用
          // });
