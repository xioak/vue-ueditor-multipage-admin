...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        // UMEDITOR_HOME_URL : "http://localhost:8080"

        UMEDITOR_HOME_URL : URL

        //图片上传配置区
        ,imageUrl: "http://localhost:8080/xenon/umeditor/images/upload"             //图片上传提交地址
        ,imagePath: "http://localhost:8080/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
